...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3844',
            //extent: [476149.194100, 495740.821200, 479827.147000, 499277.763900],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([473585.182556, 494953.433631, 482208.286556, 500204.597427], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_CopaciUATMerghindeal_6,
    colName: 'Nr. ID',
    zoom: 10,
    collapsed: true,
    map: map,
